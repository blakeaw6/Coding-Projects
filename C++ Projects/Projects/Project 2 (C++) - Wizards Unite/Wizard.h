 ...
 **
 ** This file contains the Header file for Wizard.cpp 
 ***************************************************************************/
...
class Wizard{
 public:
  ...
  // Preconditions: Requires a valid Foundable
  //(from m_allFoundables)
  ...
  // Postconditions: Returns true if exists in
  //m_foundables else false
  bool CheckFoundable(Foundable newFoundable);
    
  // Name: AttackFoundable()
  // Preconditions: Requires valid enemy (Foundable pointer)
  // Postconditions: Compares Wizard toughness to the enemy
  //toughness (tie goes to enemy) Returns result of comparison
  bool AttackFoundable(Foundable enemy);
  
  // Name: PrintMyFoundables()
  // Preconditions: None
  // Postconditions: Displays a list of all foundables
  //found by Wizard else indicates none found
  void PrintMyFoundables();
  
private:
  // Name: IncreaseLevel()
  // Preconditions: None
  // Postconditions: Updates m_level by one and increases
  // toughness from 0 to 100
  void IncreaseLevel();
