 ...
 **
 ** This file contains the Header file for Game.cpp
 ***************************************************************************/
#include <iostream>
#include <fstream>
#include <string>
...
public:
  ...
  // Preconditions: Foundable file must be loaded successfully
...
private:
  ...
  Foundable m_allFoundables[NUM_FOUNDABLE]; //Master list of all
                                            //Foundables in game
};
