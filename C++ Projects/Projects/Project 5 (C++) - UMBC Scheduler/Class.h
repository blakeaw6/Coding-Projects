 ...
 ** This file contains the header file of the Class class
 *****************************************************************************/

#ifndef CLASS_H //header guard
#define CLASS_H //header guard

#include <iostream>
#include <string>
#include "Tqueue.cpp" //Tqueue must be created first 
#include "Student.h" //Student must be created first 
using namespace std;
...
class Class{
 public:
  ...
  //Desc: When an m_roster is full and m_waitlist is full, copies all students
  //in  m_waitlist to a destination Class
  //Precondition: m_waitlist is full
  //Postcondition: m_waitlist is empty and all students were transferred to
  //new Class
